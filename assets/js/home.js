...
/*quotes*/
 ...
 var q_arr=['Unknown','FAILURE IS THE CONDIMENT THAT GIVES <span style="color:#00c209;">SUCCESS</span>','<span style="color:#00c209">IMAGINATION</span> IS MORE IMPORTANT THAN KNOWLEDGE','MAN IS MORTAL<br>SO,BE HONEST','Time always flies but<br>good relation never dies'];
 var q_arr_length=q_arr.length-1;
 var q_arr_loc=document.querySelector(".q-text");
 var q_arr_num=0;
 setInterval(function(){
   ++q_arr_num;
   if(q_arr_num>q_arr_length){
      q_arr_num-=q_arr_length;
   }
   q_arr_loc.innerHTML=q_arr[q_arr_num];
 },3000);
